let productos = [
    ...
    { titulo: 'Calcetín Caballero mediana compresión', categoria: 'Medias', subcategoria: 'Mediana Compresión', descripcion: 'Se recomiendan para personas que pasan mucho tiempo de pie o sentadas y que practican poca actividad física. Ayuda a prevenir los problemas de várices. Además de comodidad para el usuario', features: ['De 30 a 18 MMHG', 'Graduada en Gradientes', '72% Poliamida 6/6 (Nylon)', '28% Elastano Spandez (Lycra)', 'Mr Doble Cover', 'Tallas: S, M, L, XL'] },
    ...
    { titulo: 'Calcetín Caballero baja compresión', categoria: 'Medias', subcategoria: 'Baja Compresión', descripcion: 'Se recomiendan para personas que pasan mucho tiempo de sentadas y que practican poca actividad física. Ayuda a prevenir los problemas de várices. Además de comodidad para el usuario', features: ['De 15 a 8 MMHG', 'Graduada en Gradientes', '28% Poliamida 6/6 (Nylon)', '72% Elastano Spandez (Lycra)', 'Mr Doble Cover', 'Tallas: S, M, L, XL'] },
    ...
    { titulo: 'Vendas impregnadas con óxido de zinc', categoria: 'Vendas', subcategoria: 'Con o Sin Calamina', descripcion: 'Venda Elástica de tejido plano, impregnada con 27 g de óxido de zinc 10.2 cm x 9.1 m Descartable. Auxiliar en el tratamiento ambulatorio de piernas con úlceras, que deriven en: ', features: ['Estasis Venosa', 'Edema Linfático', 'Tromboflebitis', 'Eczema de las piernas'] },
    { titulo: 'Vendas impregnadas con óxido de zinc y calamina', categoria: 'Vendas', subcategoria: 'Con o Sin Calamina', descripcion: 'Venda Elástica de tejido plano, impregnada con 2 g de calamina y 27 g de óxido de zinc 10.2 cm x 9.1 m Descartable. Auxiliar en el tratamiento ambulatorio de piernas con úlceras, que deriven en: ', features: ['Estasis Venosa', 'Edema Linfático', 'Tromboflebitis', 'Eczema de las piernas'] },
    { titulo: 'Sujetador de tubo endotraqueal', categoria: 'Sujetadores', subcategoria: 'Tubo Endotraqueal', descripcion: 'Cintas de Esponja y velcro, canal plástico para tubo, base adhesiva, descartable', features: [] },
    { titulo: 'Sujetador de sonda nasográstrica', categoria: 'Sujetadores', subcategoria: 'Nasogástricos', descripcion: 'Polímero adhesivo-tejido en forma de mariposa, con dos tiras de fijación, descartable', features: [] },
    ...
    { titulo: 'Sujetador para traqueostomo', categoria: 'Sujetadores', subcategoria: 'Traqueostomo', descripcion: 'Esponja con extremos de velcro para sujeción, regulable, libre de látex, descartable', features: [] },
    { titulo: 'Alfombra Antibacteriana', categoria: 'Alfombras', subcategoria: 'Eco Amigable', descripcion: 'Esta diseñada para ser localizada en la entrada de espacios que requieren una desinfección diaria y profunda. Tiene como fin la eliminación de bacterias presentes en el calzado. Alfombra antibactearana biohíbrida, es el primer producto de control de contaminación que contiene materiales renovables a base de plantas, proporcionando una alternativa amigable con el medio ambiente para casas de salud socialmente responsables', features: ['Amigable con el medio ambiente: Es libre de GMO, reciclable, a base de plantas, materiales de Cardia Biohybrid que reducen emsiones de CO2', 'Potenciador de imagen: Disminuye la huella visible de carbono', 'Reciclable: Puede ser reciclado en cualquier flujo convencional de reciclado de plástico'] },
    { titulo: 'Monitores Fetales', categoria: 'Papeleria', subcategoria: 'Rollos & Packs', descripcion: 'La papelería médica industrial sirve para capturar (imprimir) en forma exacta la información tomada por un equipo', features: ['Papel para monitor fetal', 'Papel para electrocardiógrafos', 'Papel para electroencefalogramas', 'Papel para ecografías', 'Papel para gasómetros', 'Toda aquella papelería que sea usada en un equipo médico'] },
    ...
    { titulo: 'Desfibriladores', categoria: 'Papeleria', subcategoria: 'Rollos & Packs', descripcion: 'La papelería médica industrial sirve para capturar (imprimir) en forma exacta la información tomada por un equipo', features: ['Papel para monitor fetal', 'Papel para electrocardiógrafos', 'Papel para electroencefalogramas', 'Papel para ecografías', 'Papel para gasómetros', 'Toda aquella papelería que sea usada en un equipo médico'] },
    { titulo: 'Otros equipos', categoria: 'Papeleria', subcategoria: 'Rollos & Packs', descripcion: 'La papelería médica industrial sirve para capturar (imprimir) en forma exacta la información tomada por un equipo', features: ['Papel para monitor fetal', 'Papel para electrocardiógrafos', 'Papel para electroencefalogramas', 'Papel para ecografías', 'Papel para gasómetros', 'Toda aquella papelería que sea usada en un equipo médico'] },
];
