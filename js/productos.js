let productos = [
    ...
    { titulo: 'Calcetin Caballero mediana compresión', categoria: 'Medias', subcategoria: 'Mediana Compresión', descripcion: 'Se recomiendan para personas que pasan mucho tiempo de pie o sentadas y que practican poca actividad física. Ayuda a prevenir los problemas de várices. Además de comodidad para el usuario', features: ['De 30 a 18 MMHG', 'Graduada en Gradientes', '72% Poliamida 6/6 (Nylon)', '28% Elastano Spandez (Lycra)', 'Mr Doble Cover', 'Tallas: S, M, L, XL'] },
